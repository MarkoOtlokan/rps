<template>
    <b-col>
        ...
        <b-modal size="lg" :title="productSpecificationModal.title" :id="productSpecificationModal.id" ok-only>
            <product-specification :product="productSpecificationModal.product"></product-specification>
        </b-modal>
...
export default {
    ...
    methods:{
        ...
        showProductSpec(item,button){
            this.productSpecificationModal.product = item
            this.productSpecificationModal.title = 'Product ' + item.name
            this.$root.$emit('')
            this.$root.$emit('bv::show::modal',this.productSpecificationModal.id,button)
        },
