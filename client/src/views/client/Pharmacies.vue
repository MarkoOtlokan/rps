    ...
    <div class="row">
        <div class="my-2 col-3 ml-2">
            <div class="w-75 text-right">
                <div class="m-2">
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-info">
                            <input type="radio" @click="sortByName"> Ime
                        </label>
                        <label class="btn btn-info">
                            <input type="radio" @click="sortByCity"> Grad
                        </label>
                        <label class="btn btn-info">
                            <input type="radio" @click="sortByRating"> Rejting
                        </label>
                    </div>
                </div>
                <hr>
                ...
                <div class="m-2">
                    <button class="btn btn-info ml-1" @click="filterPharmacies">Filtriraj po rejtingu</button>
                </div>
                <hr>
                <div class="m-2">
                    <button class="btn btn-danger ml-1" @click="reset">Restartuj filtere</button>
                </div>
